...
export default function ServiceConsultancy() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-24" aria-labelledby="consultancy-heading">
      <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 relative">
        ...
        <div className="lg:w-1/3 relative">
          ...
          >
            ...
            <h2 id="consultancy-heading" className="text-4xl md:text-5xl font-bold tracking-tighter text-foreground leading-[0.9]">
              Strategic <br /> 
            ...
            <p className="mt-8 text-muted text-[17px] leading-relaxed font-light max-w-sm">
              ...
              <span className="text-foreground font-medium"> complex infrastructure</span> and 
              ...
              {[
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-muted uppercase tracking-widest font-bold mt-0.5 opacity-60">{item.detail}</p>
                  </div>
                </motion.div>
              ))}
            </div>
        ...
        <div className="lg:w-2/3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            {domains.map((domain, i) => (
              ...
              >
                <div>
                  ...
                  <h4 className="text-2xl font-bold mb-4 tracking-tight text-foreground">{domain.title}</h4>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-foreground dark:bg-zinc-100 p-10 rounded-[2.5rem] flex flex-col justify-between items-start group cursor-pointer border border-transparent hover:border-accent transition-all duration-500 shadow-2xl"
            >
               <div>
                 <p className="text-accent text-[10px] font-black uppercase tracking-[0.3em] mb-6">Immediate Value</p>
                 <h4 className="text-background dark:text-foreground text-3xl font-bold tracking-tighter leading-[0.9]">Request a <br /> Technical Audit</h4>
                 <p className="mt-4 text-background/60 dark:text-foreground/60 text-sm font-light">Identifying bottlenecks in your stack to prepare for AI integration.</p>
               </div>
               
               <div className="mt-10 w-full flex justify-between items-center group-hover:translate-x-1 transition-transform">
                 <span className="text-accent text-[11px] font-bold uppercase tracking-widest">Book Discovery</span>

...
export default function TheDualPath() {
  ...
  return (
    <section className="relative w-full py-20 md:py-32 overflow-hidden transition-colors duration-500 bg-background">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          >
            Two Paths.{" "}
            <span className="text-cyan-600 dark:text-cyan-400 italic font-medium">
              One Standard.
            </span>
          </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted mb-10 max-w-[300px] text-base font-light leading-relaxed">
                Custom machine learning, data infrastructure, and system
                architecture for companies ready to scale.
              </p>
              <a
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted mb-10 max-w-[300px] text-base font-light leading-relaxed">
                Practical, project-based training for engineers and data
